...
(function ($) {
    ...
    $.widget('wp.wpColorPicker', $.wp.wpColorPicker, {
        _create: function () {
            ...
            self.wrap = el.parent();
            self.toggler = $(_before).insertBefore(el).css({backgroundColor: self.initialValue})
				.attr('title', __('Select Color'))
				.attr('data-current', __('Current Color'));
            ...
            if (this.options.alpha) {
                ...
                if (target.hasClass('wp-picker-open')) {
                    ...
                    if (self._color._alpha < 1) {
                        ...
                        el.width(parseInt(defaultWidth + customWidth + 50));
                    } else {
                        el.width(customWidth - 15);
                    }
                }
            }
